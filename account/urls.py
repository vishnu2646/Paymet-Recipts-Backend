...
urlpatterns = [
    ...
    path('income/detail/<int:incid>/',IncomeDetail, name='income-detail'),
    path('income/create/', AddIncome.as_view(), name='income-create'),
    path('income/update/<int:incid>/', UpdateIncome.as_view(), name='income-update'),
    path('income/delete/<int:incid>/', DeleteIncome, name='income-delete'),

    path('expense/list/', ExpenseList, name='expense-list'),
    path('expense/detail/<int:expid>/',ExpenseDetail, name='expense-detail'),
    path('expense/create/', AddExpense.as_view(), name='expense-create'),
    path('expense/update/<int:expid>/', UpdateExpense.as_view(), name='expense-update'),
    path('expense/delete/<int:expid>/', DeleteExpense, name='expense-delete'),
